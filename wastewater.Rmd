...
```{r document_setup, echo=FALSE, message=FALSE}
library(readr)
library(xts)
library(zoo)
library(curl)
...
csvUrl = 'https://www.covid19.admin.ch/api/data/20230418-9fimp7v8/sources/COVID19Wastewater_vl.csv'
...
**Date of document generation: 2023-04-19**
